...
public class GameManager3 : MonoBehaviour
{
    ...
    [SerializeField] private HexagonFT _hexagonFT;
    [SerializeField] private HexagonPT _hexagonPT;
    ...
    void Update()
    {
       if(triangle.counter_triangle == 1 && square.counter_square == 1 && _capusle.counter_capsule == 1 && _hexagonFT.counter_hexagon_ft == 1
       && _hexagonPT.counter_HexagonPT == 1)
       {
